        ...
        <div className='relative w-full flex flex-col items-center min-h-[100dvh]'>
          ...
          <div className='container mx-auto flex flex-col items-center justify-start relative z-10'>
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                <motion.h2
                  className='hero-title text-4xl md:text-5xl lg:text-6xl font-bold text-blue-200 transition-none leading-none'
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className='hero-title text-4xl md:text-5xl lg:text-6xl font-bold text-center text-blue-200 transition-none leading-none'
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
                ...
                {centerText && (
                  <motion.div
                    ...
                    transition={{ duration: 0.1 }}
                  >
                    <h2 className="text-2xl md:text-4xl lg:text-6xl font-black text-center text-white drop-shadow-[0_0_20px_rgba(30,58,138,0.5)] tracking-tight max-w-[90vw] leading-tight">
                      {centerText}
                    </h2>
                  </motion.div>
                )}
